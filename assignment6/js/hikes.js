...
findBechler();
function findBechler() {
  let returnarray = JSON.parse(localStorage.getItem('commentarray'));
  const comment = JSON.parse(localStorage.getItem('commentarray', JSON.stringify(commentarray))).filter(it => it.name === "Bechler Falls");
  console.log(comment);
  return comment;
}
